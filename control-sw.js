const SHELL_CACHE = "baupass-control-shell-v36";
const RUNTIME_CACHE = "baupass-control-runtime-v36";
const SHELL_ASSETS = [
  "/",
  "/index.html",
  "/index.html?v=20260418e",
  "/app.js",
  "/app.js?v=20260418e",
  "/styles.css",
  ...
  if (isNavigation) {
    event.respondWith(
      networkFirst(request).catch(async () => (
        ...
        (await caches.match("/index.html?v=20260418e")) ||
