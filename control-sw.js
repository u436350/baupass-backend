const SHELL_CACHE = "baupass-control-shell-v26";
const RUNTIME_CACHE = "baupass-control-runtime-v26";
const SHELL_ASSETS = [
  "/",
  "/index.html",
  "/index.html?v=20260417f",
  "/app.js",
  "/app.js?v=20260417f",
  "/styles.css",
  ...
  if (isNavigation) {
    event.respondWith(
      networkFirst(request).catch(async () => (
        ...
        (await caches.match("/index.html?v=20260417f")) ||
